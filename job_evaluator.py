#!/usr/bin/env python3
"""
Job Evaluator Agent (SCRUBBED) - Score job postings against Shannon's career criteria
...
def create_scoring_prompt(job_content: str, criteria: str, company: str, title: str) -> str:
    ...
    return f"""You are evaluating a job posting for fit against the candidate's background and job search criteria.
